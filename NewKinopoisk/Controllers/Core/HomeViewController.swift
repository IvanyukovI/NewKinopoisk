...
class HomeViewController: UIViewController {
    ...
    let sectionTitles: [String] = ["Trending Movies","Trending TV", "Top 250 Movies", "Top 250 TVs"]
...
extension HomeViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        guard let cell = tableView.dequeueReusableCell(withIdentifier: CollectionViewTableViewCell.idetifier, for: indexPath) as? CollectionViewTableViewCell else { return UITableViewCell()}
        ...
        case Sections.top250TVs.rawValue:
            APICaller.shared.getTop250TVs { result in
                switch result {
                case .success(let titles):
                    cell.configure(with: titles)
                case .failure(let error):
